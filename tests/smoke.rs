...
use rc5::{decrypt_default, encrypt, encrypt_default};
...
fn encode_reference_32_20_16() {
  ...
  let res = encrypt::<u32>(&key, &pt, 20).unwrap();
...
fn encode_reference_64_24_24() {
  ...
  let res = encrypt::<u64>(&key, &pt, 24).unwrap();
...
fn encode_reference_128_28_32() {
  ...
  let res = encrypt::<u128>(&key, &pt, 28).unwrap();
